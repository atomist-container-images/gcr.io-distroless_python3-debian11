...
FROM gcr.io/distroless/python3-debian11:debug-nonroot-arm64
...
# Tags: debug-arm64
FROM gcr.io/distroless/python3-debian11:debug-arm64
...
# Tags: debug-amd64
FROM gcr.io/distroless/python3-debian11:debug-amd64
